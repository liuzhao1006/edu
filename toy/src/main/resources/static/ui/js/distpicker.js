...
/***/ function(module, exports) {
	...
	Object.defineProperty(exports, "__esModule", {
	  value: true
       ...
       /* var ids=$("#id").val();
        var companyTypeInfo = $("#companyTypeInfo").val();
        if(ids!=undefined &&companyTypeInfo==3){
            var provinces =$("#ProvinceInfos").val();
            var b = false;
            if(provinces==null||provinces==""){
                provinces='—— 省 ——';
                b=true;
			}
            var citys =$("#CityInfos").val();
            if(citys==null||citys==""){
                citys='—— 市 ——';
                b=true;
            }
            var districts=$("#AreaIDInfos").val();
            ...
            exports.default = {
                ...
                // Defines the  value of province.
                province: provinces,

                // Defines the value of city.
                city: citys,

                // Defines the value of district.
                district: districts
            };
		}else {*/
            exports.default = {
